...
abstract class Core
{
    const URL_INDEX_MARKETPLACE_ID = 'MarketplaceId.Id.';
    const URL_INDEX_MARKETPLACE_LIST_ID = 'MarketplaceIdList.Id.';

    const MOCK_FILE_ACKNOWLEDGE_REPORTS = 'acknowledgeReports.xml';
    const MOCK_FILE_CANCEL_FEEDS = 'cancelFeeds.xml';
    const MOCK_FILE_CANCEL_REQUESTS = 'cancelRequests.xml';
    const MOCK_FILE_COUNT_FEEDS = 'countFeeds.xml';
    const MOCK_FILE_CREATE_SHIPMENT = 'createShipment.xml';
    const MOCK_FILE_FETCH_CATEGORIES = 'fetchCategories.xml';
    const MOCK_FILE_FETCH_COMPETITIVE_PRICING = 'fetchCompetitivePricing.xml';
    const MOCK_FILE_FETCH_FEED_RESULT = 'fetchFeedResult.xml';
    const MOCK_FILE_FETCH_FEED_SUBMISSIONS = 'fetchFeedSubmissions.xml';
    const MOCK_FILE_FETCH_FEED_SUBMISSIONS_TOKEN = 'fetchFeedSubmissionsToken.xml';
    const MOCK_FILE_FETCH_FEED_SUBMISSIONS_TOKEN2 = 'fetchFeedSubmissionsToken2.xml';
    const MOCK_FILE_FETCH_FULFILLMENT_ORDER = 'fetchFulfillmentOrder.xml';
    const MOCK_FILE_FETCH_FULFILLMENT_ORDER_LIST = 'fetchFulfillmentOrderList.xml';
    const MOCK_FILE_FETCH_FULFILLMENT_ORDER_LIST_TOKEN = 'fetchFulfillmentOrderListToken.xml';
    const MOCK_FILE_FETCH_FULFILLMENT_ORDER_LIST_TOKEN2 = 'fetchFulfillmentOrderListToken2.xml';
    const MOCK_FILE_FETCH_INVENTORY_LIST = 'fetchInventoryList.xml';
    const MOCK_FILE_FETCH_INVENTORY_LIST_TOKEN = 'fetchInventoryListToken.xml';
    const MOCK_FILE_FETCH_INVENTORY_LIST_TOKEN2 = 'fetchInventoryListToken2.xml';
    const MOCK_FILE_FETCH_LOWEST_OFFER = 'fetchLowestOffer.xml';
    const MOCK_FILE_FETCH_MY_PRICE = 'fetchMyPrice.xml';
    const MOCK_FILE_FETCH_ORDER = 'fetchOrder%s.xml';
    const MOCK_FILE_FETCH_ORDER_ITEMS = 'fetchOrderItems%s.xml';
    const MOCK_FILE_FETCH_ORDER_ITEMS_TOKEN = 'fetchOrderItemsToken.xml';
    const MOCK_FILE_FETCH_ORDER_ITEMS_TOKEN2 = 'fetchOrderItemsToken2.xml';
    const MOCK_FILE_FETCH_ORDER_LIST = 'fetchOrderList.xml';
    const MOCK_FILE_FETCH_ORDER_LIST_TOKEN = 'fetchOrderListToken.xml';
    const MOCK_FILE_FETCH_ORDER_LIST_TOKEN2 = 'fetchOrderListToken2.xml';
    const MOCK_FILE_FETCH_PARTICIPATION_LIST = 'fetchParticipationList.xml';
    const MOCK_FILE_FETCH_PARTICIPATION_LIST_TOKEN = 'fetchParticipationListToken.xml';
    const MOCK_FILE_FETCH_PARTICIPATION_LIST_TOKEN2 = 'fetchParticipationListToken2.xml';
    const MOCK_FILE_FETCH_PLAN = 'fetchPlan.xml';
    const MOCK_FILE_FETCH_PREVIEW = 'fetchPreview.xml';
    const MOCK_FILE_FETCH_PRODUCT_LIST = 'fetchProductList.xml';
    const MOCK_FILE_FETCH_REPORT = 'fetchReport.xml';
    const MOCK_FILE_FETCH_REPORT_COUNT = 'fetchReportCount.xml';
    const MOCK_FILE_FETCH_REPORT_LIST = 'fetchReportList.xml';
    const MOCK_FILE_FETCH_REPORT_LIST_TOKEN = 'fetchReportListToken.xml';
    const MOCK_FILE_FETCH_REPORT_LIST_TOKEN2 = 'fetchReportListToken2.xml';
    const MOCK_FILE_FETCH_REPORT_REQUEST_COUNT = 'fetchReportRequestCount.xml';
    const MOCK_FILE_FETCH_REPORT_REQUEST_LIST = 'fetchReportRequestList.xml';
    const MOCK_FILE_FETCH_REPORT_REQUEST_LIST_TOKEN = 'fetchReportRequestListToken.xml';
    const MOCK_FILE_FETCH_REPORT_REQUEST_LIST_TOKEN2 = 'fetchReportRequestListToken2.xml';
    const MOCK_FILE_FETCH_REPORT_SCHEDULE_COUNT = 'fetchReportScheduleCount.xml';
    const MOCK_FILE_FETCH_REPORT_SCHEDULE_LIST = 'fetchReportScheduleList.xml';
    const MOCK_FILE_FETCH_REPORT_SCHEDULE_LIST_TOKEN = 'fetchReportScheduleListToken.xml';
    const MOCK_FILE_FETCH_REPORT_SCHEDULE_LIST_TOKEN2 = 'fetchReportScheduleListToken2.xml';
    const MOCK_FILE_FETCH_SERVICE_STATUS = 'fetchServiceStatus.xml';
    const MOCK_FILE_FETCH_SHIPMENT_ITEMS = 'fetchShipmentItems.xml';
    const MOCK_FILE_FETCH_SHIPMENT_ITEMS_TOKEN = 'fetchShipmentItemsToken.xml';
    const MOCK_FILE_FETCH_SHIPMENT_ITEMS_TOKEN2 = 'fetchShipmentItemsToken2.xml';
    const MOCK_FILE_FETCH_SHIPMENTS = 'fetchShipments.xml';
    const MOCK_FILE_FETCH_SHIPMENTS_TOKEN = 'fetchShipmentsToken.xml';
    const MOCK_FILE_FETCH_SHIPMENTS_TOKEN2 = 'fetchShipmentsToken2.xml';
    const MOCK_FILE_FETCH_TRACKING_DETAILS = 'fetchTrackingDetails.xml';
    const MOCK_FILE_MANAGE_REPORT_SCHEDULE = 'manageReportSchedule.xml';
    const MOCK_FILE_REQUEST_REPORT = 'requestReport.xml';
    const MOCK_FILE_SAVE_FEED = 'saveFeed.xml';
    const MOCK_FILE_SAVE_REPORT = 'saveReport.xml';
    const MOCK_FILE_SEARCH_PRODUCTS = 'searchProducts.xml';
    const MOCK_FILE_SUBMIT_FEED = 'submitFeed.xml';
    const MOCK_FILE_UPDATE_SHIPMENT = 'updateShipment.xml';

    /**
     * @var string $urlbase , Amazon Api Url
     */
    protected $urlbase = \Amazon\Sdk\Marketplace::URL_NORTH_AMERICA;
    ...
    /**
     * @var \Amazon\Sdk\Api\ConfigInterface $config
     */
    protected $config;
    ...
    /**
     * Amazon\Core constructor sets up key information used in all Amazon requests.
     *
     ...
     * @param array|string|null $mockFiles [optional] <p>The files (or file) to use in Mock Mode.
    ...
    protected function __construct(
        ...
        $this->setMock($mockMode, $mockFiles);
     ...
     * include your Seller Id, Access Key Id, and Secret Key, and are critical
     * for making requests with Amazon. If any of the key values are missing,
     * the incident will be logged.
     * @param \Amazon\Sdk\Api\ConfigInterface $config
     * @throws \Amazon\Sdk\Api\Exception\InvalidConfigValue
     */
    public function setConfig(\Amazon\Sdk\Api\ConfigInterface $config)
    {
        $this->config = $config;
        try {
            $sellerId = $config->getSellerId();
            if (isset($sellerId) && !empty($sellerId)) {
                if ($this->config->getMode() == ConfigInterface::API_MODE_MERCHANT) {
                    $this->options['Merchant'] = $sellerId;
                } else {
                    $this->options['SellerId'] = $sellerId;
                }
            } else {
                throw new \Amazon\Sdk\Api\Exception\InvalidConfigValue('Seller Id is missing.');
            }

            $accessKeyId = $config->getAccessKeyId();
            if (isset($accessKeyId) && !empty($accessKeyId)) {
                $this->options['AWSAccessKeyId'] = $accessKeyId;
            }

            $mwsAuthToken = $config->getAuthToken();
            if (isset($mwsAuthToken) && !empty($mwsAuthToken)) {
            ...
            if (isset($serviceUrl) && !empty($serviceUrl)) {
                ...
                // Service Url is set from Marketplace Id.
                // @TODO handle multi marketplace in config.
                throw new \Amazon\Sdk\Api\Exception\InvalidConfigValue('Service Url is missing.');
            }

            $secretKey = $config->getSecretKey();
            if (!isset($secretKey) || empty($secretKey)) {
                throw new \Amazon\Sdk\Api\Exception\InvalidConfigValue('Secret Key is missing.');
            }
        } catch (\Amazon\Sdk\Api\Exception\InvalidConfigValue $e) {
            $this->log($e->getMessage(), 'ERROR', ['config' => var_export($config, true)]);
        }
    }
     ...
     * @TODO: This includes the priority level, and a backtrace of the call.
     * @param string $message <p>The message to write to the log.</p>
     * @param string $level [optional] <p>The priority level of the message.</p>
     * @param array $context [optional] <p>Details to be written in log</p>
     * </p>This is merely for the benefit of the user and does not affect how
     * the code runs. The values used in this library are "Info", "WARNING",
     * "ALERT", and "Throttle".</p>
     * @return boolean <b>FALSE</b> if the message is empty, NULL if logging is muted
     */
    protected function log($message = null, $level = 'INFO', array $context = [])
    {
        if (isset($message, $this->logger)) {
            $muteLog = $this->config->getMuteLog();
    ...
    public function setMock($b = true, $files = null)
    {
        if (is_bool($b)) {
            ...
            if ($b) {
                ...
                if (!isset($files)) {
                    $path = realpath(__DIR__ . '/../../test-cases/mock/');
                    if (!empty($path)) {
                        $files = scandir($path);
    ...
    public function setMarketplaceIds($s)
    {
        if ($s && is_string($s)) {
            ...
            $this->options[self::URL_INDEX_MARKETPLACE_ID . '1'] = $s;
            return true;
        } elseif ($s && is_array($s)) {
            $this->resetMarketplaceIds();
            $i = 1;
            foreach ($s as $x) {
                $this->options[self::URL_INDEX_MARKETPLACE_ID . $i] = $x;
                $i++;
            }
            return true;
        }
     ...
     * to sell in. If this is not set, Amazon will only use the first Marketplace
     * you are registered for.
     * @param array|string $s <p>A list of Marketplace List IDs, or a single ID string.</p>
     * @return boolean <b>FALSE</b> if improper input
     */
    public function setMarketplaceListIds($s)
    {
        if ($s && is_string($s)) {
            $this->resetMarketplaceListIds();
    ...
    public function resetMarketplaceIds()
    {
        foreach ($this->options as $op => $junk) {
            if (preg_match("#" . self::URL_INDEX_MARKETPLACE_ID . "#", $op)) {
     ...
     * parameters you previously set.
     */
    public function resetMarketplaceListIds()
    {
        foreach ($this->options as $op => $junk) {
     ...
     * @return \SimpleXMLElement|string|boolean <p>A SimpleXMLObject holding the
     ...
     */
    protected function fetchMockFile($name = null, $load = true)
    {
        $response = false;
        ...
        if (isset($url) and file_exists($url)) {
            try {
                $this->log("Fetched Mock File: $url");
                $response = file_get_contents($url);
                $this->rawResponses[]['body'] = $response;
                if ($load and !empty($response)) {
            ...
            $this->log("Mock File not found: $name", 'WARNING');
        }
  ...
  <RequestID>123</RequestID>
    ...
    protected function checkResponse($r)
    {
        ...
        if ($r['code'] == 200) {
            ...
            $this->log(
                "Bad Response! " . $r['code'] . " " . $r['error'] . ": " . $xml->Code . " - " .
                $xml->Message,
                'ERROR',
                ['response' => $r]
            );
    ...
    {
        $this->log(
            "Making request to Amazon: " . $this->options['Action'],
            'INFO',
            ['url' => $url, 'param' => $param]
        );
        ...
        if (isset($context['response']['body'])) {
            if (strlen($context['response']['body']) > 1000) {
                unset($context['response']['body']);
            }
        }
        $this->log(
            "Request completed from Amazon: " . $this->options['Action'],
            'INFO',
            $context
        );
    ...
    public function fetchURL($url, $param)
    {
        ...
        $strpos = strpos($data, 'HTTP/1.1 100 Continue');
        ...
        if ($return['code'] == '200' || $return['code'] == '302') {
            ...
            $return['error'] =
                (($return['answer'] and $return['answer'] != 'OK') ? $return['answer'] : 'Something wrong!');
            $return['ok'] = 0;
            $this->log('Api Failure', 'DEBUG', ['code' => $return['code'], 'response' => $data]);
        }
    ...
    protected function sleep()
    {
        ...
        $this->log(
            "Request was throttled. Sleeping for " . $this->throttleTime . " second $s",
            'DEBUG',
